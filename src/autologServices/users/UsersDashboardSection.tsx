...
export const companyAccountGeneralInfoForm = [
    ...
    {name: "companyName", label: "Company Name", editor: "textbox", required: true},
    ...
    {name: "phoneNumber", label: "Phone Number", editor: "phonemasktextbox", required: true},
    {name: "emailAddress", label: "Email", editor: "textbox", required: true},
    {name: "additionalInfo", label: "Additional info about your company:", editor: "multilinetextbox"}
];


const companyAccountCreationMessages: AutologSystemMessageSchema = new Map([
    ['success', {message: 'User was created.'}],
    ['error', {message: 'There was an error during user creation, please check errors.'}],
]);
...
const freightForwarderSchema: Schema[] = [
    ...
    {name: "officeAddress", label: "Office Address", editor: "textbox", required: true},
...
const importerExporterSchema: Schema[] = [
    ...
    {name: "vatNumber", label: "VAT Number", editor: "textbox", required: true},
    {name: "businessField", label: "Business Field", editor: "textbox", required: true},
    {name: "inlandAddress", label: "Inland Address", editor: "search", required: true},
    {name: "inlandViaAutolog", label: "Inland via Autolog", editor: "radio", options: ['Yes', 'No'], required: true},
    {
    ...
    {name: "oceanPortDestination", label: "Ocean Port Destination", editor: "textbox", required: true}
...
export const newCompanyAccountNextStageCallback = (props: StepsCallbackProps) => {
...
const newCompanyAccountStepForm: StepForm = [newCompanyAccountNextStageCallback, companyAccountCreationFormMap];
...
export const companyAccountDetailsSchema: EntityDetailsSchema<AccountApplicationsProps> = {
    ...
    splitOverViewAndDetails(entity: AccountApplicationsProps): { sourceFields: { [p: string]: any }; detailsFields: { [p: string]: any } } {
        const {id,companyType, companyName, firstName, lastName, additionalInfo, emailAddress, phoneNumber, userRole, ...otherFields} = entity;
        return {
            sourceFields: {
                companyType,
                companyName,
...
export const UsersDashboardSection = () => {
    return <AutologDashboardSection entityNames={['Company Accounts']} domainSchema={domainSchema}/>;
};
