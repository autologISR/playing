...
export const TableCurrency: React.FunctionComponent<CustomComponentProps> = (props: CustomComponentProps) => {
...
export const currencyCustomComponentFunc = (props: CustomComponentFuncProps) => {
...
export const rowIndexField = {head: true, field: 'rowIndex', value: '', readOnly: true};
export const WeightLimits: React.FunctionComponent<CustomComponentProps> = (props: CustomComponentProps) => {
    const {customComponentState, setCustomComponentState} = props;
    const [fromWeight, setFromWeight] = React.useState<string>();
    const [fromWeightColumn, setFromWeightColumn] = React.useState<GridElement | undefined>();
...
export const WeightLimitsComponent: React.FunctionComponent<CustomComponentProps> = (props: CustomComponentProps) => {
    return (
        <>
            <WeightLimits {...props}/>
            <TableCurrency {...props}/>
...
export const  fromWeightRatesCustomComponentFunc = (props: CustomComponentFuncProps) => {
    const {customComponentState, state} = props;
    const [headers, ...bodyRows] = state.grid;
...
export const fromWeightAdHocColumnsSpreadsheetParser: AdHocColumnsSpreadsheetParser = (fieldName => {
    const fromWeightRegex = /^from(\d+)$/;
    const fromWeightField = fieldName.match(fromWeightRegex);
    return fromWeightField === null ? fieldName : '> ' + fromWeightField[1] + ' kg'
})